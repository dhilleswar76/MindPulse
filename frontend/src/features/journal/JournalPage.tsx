  ...
  const fetchEntries = async () => {
    ...
    try {
      ...
      setEntries([
        {
          _id: 'sample_1',
          title: 'Preparing for Finals & Sleep Irregularity',
          content: 'I stayed up until 3 AM studying for organic chemistry. Feeling a bit anxious about the upcoming exam and feeling drained today.',
          sentiment: 'negative',
          stressSignal: 0.65,
          emotionSignals: ['anxiety', 'fatigue'],
          isPrivate: true,
          createdAt: new Date().toISOString(),
        },
        {
          _id: 'sample_2',
          title: 'Walked in Campus Arboretum',
          content: 'Took a 30-minute break after class to walk outside. Feeling significantly more centered and relaxed.',
          sentiment: 'positive',
          stressSignal: 0.22,
          emotionSignals: ['calmness', 'optimism'],
          isPrivate: true,
